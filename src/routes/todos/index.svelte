...
<div class="todos">
	...
	<form class="new" on:submit|preventDefault={() => addTodo()} method="post">
		<input
	...
	{#each $todos as todo (todo._id)}
		...
		>
			<form on:submit|preventDefault={() => toggleDone(todo)}>
				<input type="hidden" name="done" value={todo.done ? '' : 'true'} />
				<button class="toggle" aria-label="Mark todo as {todo.done ? 'not done' : 'done'}" />
			</form>

			<form class="text" on:submit|preventDefault={() => updateTodo(todo)}>
				<input aria-label="Edit todo" type="text" name="text" bind:value={todo.text} />
				<button class="save" aria-label="Save todo" />
			</form>

			<form on:submit|preventDefault={() => deleteTodo(todo)}>
